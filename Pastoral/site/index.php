...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pastoral do Esporte</title>
        ...
        <script type="text/javascript">
            jQury.fn.infiniteCarousel = function () {			 
                function repeat(str, num) {
                    return new Array( num + 1 ).join( str );
                }
			  
                return this.each(function () {
                    var $wrapper = jQury('> div', this).css('overflow', 'hidden'),
                    ...
                    jQury('a.back', this).click(function () {
                        return gotoPage(currentPage - 1);                
                    });
			        
                    jQury('a.forward', this).click(function () {
                        return gotoPage(currentPage + 1);
                    });
			        
                    // create a public interface to move to a specific page
                    jQury(this).bind('goto', function (event, page) {
                        gotoPage(page);
                    });
                });  
            };
        ...
        <script type="text/javascript">      
            jQury(document).ready(function () {
                jQury('.infiniteCarousel').infiniteCarousel();
            });
        </script> 
    </head>
    <body>
