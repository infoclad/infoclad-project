		...
		<div id="novidades" class="b wrapper">
			...
			<span class="b">
				...
				<span class="b l minParagraph p">
					...
					vida cotidiana. E a forma encontrada para fazer com que isso aconteça, é que cada
					um terá uma estampa única e exclusiva.<br/><br/> 
					Faremos apenas 50 unidades de t-shirts por arte, e as venderemos em 
